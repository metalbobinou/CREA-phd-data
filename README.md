...
Full-Text-* are matrices based only on courses made with texts (no slide) from the 18 [C3, C5, C6, C11, C15, C17, C19]

Full-Text-C+noP-* are matrices with the "hors programme" (extra-curricular) part of the course (C), but without the students projects (noP)

Full-Text-noC+noP-* are matrices without the "hors programme" (extra-curricular) part of the course (noC), and without the students projects (noP)
